...
public class categoryShopListModel {
    ...
    public categoryShopListModel(Integer status, String message, Data data) {
        this.status = status;
    ...
    public class Data {
        ...
        public class Datum {
            ...
            public Datum(Integer id, String title, String photo, String status) {
                this.id = id;
                this.title = title;
                this.photo = photo;
                this.status = status;
